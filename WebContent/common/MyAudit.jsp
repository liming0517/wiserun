...
<script type = "text/JavaScript">
	...
	function loadGrid(icmodename,iccreatedate1,iccreatedate2) {
		$(function() {
			...
			$('#myauditlist').datagrid({
				...
				queryParams:{"active":"quemyaudit","modename":icmodename,"createdate1":iccreatedate1,"createdate2":iccreatedate2},
				title: '待审核列表',
				width: '100%',
				nowrap: false,
				fit:true,
				...
				fitColumns: true,
				columns:[[
					{field:'模块名称',title:'审核类型',width:100},
					{field:'提醒内容',title:'审核提醒',width:100},
	...
	function doToolbar(iToolbar) {
		...
		if(iToolbar=="new") {
			...
			location.href="<%=request.getContextPath()%>"+myauditlist+"?icPC_CODE="+myauditid;
		}
	}
</script>