...
function showTree(code){
	...
	rightFrame.href = "<%=request.getContextPath()%>/form/SYSTEM/Rank/RankList.jsp?type=Config&selectMode=1&tableName=V_Node_Module&selectSql=RankCode in (select RankCode from RankAuthPart b1 where b1.AuthPartCode='" +code + "')";
}
...
function UpdateAuth(){
	...
	//获得右边框架对象
	var rightFrame = eval("parent.treearea.document");
	...
	document.form1.action="<%=request.getContextPath()%>/Svl_RankSet";
