...
if(opts.disabled){
$(_4df).addClass("validatebox-disabled").attr("disabled","disabled").css("background","#eee").css("opacity","1");
}else{
...
bc.append("<a style='margin-right:6px' href=\"javascript:;\" class=\"textbox-icon "+bb[i].iconCls+"\" icon-index=\""+i+"\" tabindex=\"-1\"></a>");
}
}
