...
//Tommy shen 桌面自定义面板 2013-8-7
myLib.NS("desktop.deskPanel");
myLib.desktop.deskPanel={
	init:function(data){
			//ep.create();
			//bindEvent();
			//myLib.desktop.deskPanel.bindEvent(data);
			myLib.desktop.deskPanel.bindEvent();
		},
		create:function(){
		...
		bindEvent:function(){
			...
			$("#inform").draggable({containment:"#desktop",start:function(){
				...
				//tommy 此处进行面板定位
				//alert("Y:"+$("#inform").offset().top+"Y:"+$("#inform").offset().left);
			}});
